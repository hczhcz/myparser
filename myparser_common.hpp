...
namespace myparser {
    ...
    const auto style_keyword = ccc::cf_red + ccc::s_italic;
    const auto style_sign = ccc::cf_red;
    const auto style_number = ccc::cf_magenta + ccc::s_bold;
    const auto style_string = ccc::cf_yellow + ccc::s_bold;
    const auto style_ignored = ccc:s_faint;
#else
